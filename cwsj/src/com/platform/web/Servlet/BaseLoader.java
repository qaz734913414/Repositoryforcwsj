...
public class BaseLoader extends HttpServlet {
	...
	public void start() throws SecurityException, NoSuchMethodException, IllegalArgumentException, MalformedURLException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
	    ...
	    String pathurl= Thread.currentThread().getContextClassLoader().getResource("").getPath(); 
